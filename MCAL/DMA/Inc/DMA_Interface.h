 ...
 * @brief          : User Interface file for DMA Module
 * @Date           : Jul 20, 2023
 ******************************************************************************
 * @attention
 *
 ...
 */
ERRORS_t DMA_ClearInterruptFlag(DMA_CONTROLLER_t DMAController, DMA_STREAMS_t StreamNumber, DMA_Interrupt_Flag_t InterruptFlag);
 ...
 * @return: ERRORS_t => Error Status To Indicate if Function Worked Properly
 */
ERRORS_t DMA_ReadInterruptFlag(DMA_CONTROLLER_t DMAController, DMA_STREAMS_t StreamNumber, DMA_Interrupt_Flag_t InterruptFlag, DMA_Interrupt_Flag_Status_t *InterruptFlagStatus);
 ...
 * @return: ERRORS_t => Error Status To Indicate if Function Worked Properly
 */
ERRORS_t DMA_SetChannel(DMA_CONTROLLER_t DMAController, DMA_STREAMS_t StreamNumber, DMA_CHANNEL_t ChannelNumber);
 ...
 * @return: ERRORS_t => Error Status To Indicate if Function Worked Properly
 */
ERRORS_t DMA_SetStreamPriority(DMA_CONTROLLER_t DMAController, DMA_STREAMS_t StreamNumber, DMA_PRIORITY_t PriorityLevel);
 ...
 * @return: ERRORS_t => Error Status To Indicate if Function Worked Properly
 */
ERRORS_t DMA_Init(DMA_INIT_STRUCT_t *Init);
 ...
 * @return: ERRORS_t => Error Status To Indicate if Function Worked Properly
 */
ERRORS_t DMA_EnableIT(DMA_INIT_STRUCT_t *DMA_InitConfig);
 ...
 * @return : ERRORS_t => Error Status To Indicate if Function Worked Properly
 */
ERRORS_t DMA_DisableStream(DMA_CONTROLLER_t DMANumber, DMA_STREAMS_t StreamNumber);
 ...
 * @return : ERRORS_t => Error Status To Indicate if Function Worked Properly
 */
ERRORS_t DMA_StartTransfer(DMA_INIT_STRUCT_t *InitConfig, uint32_t *SrcAddress, uint32_t *DestAddress, uint16_t DataLength);
 ...
 * @return : ERRORS_t => Error Status To Indicate if Function Worked Properly
 */
ERRORS_t DMA_SetCallBack(DMA_INIT_STRUCT_t *InitConfig, DMA_CALLBACK_ID_t CallBackID, void (*Copy_pvCallBack)(void));
